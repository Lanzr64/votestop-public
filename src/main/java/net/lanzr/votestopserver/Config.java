...
@Mod.EventBusSubscriber(modid = VoteStopServer.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class Config {
        ...
        public static ForgeConfigSpec.IntValue START_LIMIT_MINUTES;
        public static ForgeConfigSpec.IntValue VOTE_DURATION_SECONDS;
        public static ForgeConfigSpec.IntValue BROADCAST_INTERVAL_SECONDS;
        public static ForgeConfigSpec.ConfigValue<String> MSG_FAILED;
        public static ForgeConfigSpec.ConfigValue<String> MSG_CANCEL_PREFIX;
        public static ForgeConfigSpec.ConfigValue<String> MSG_CANCEL_PLAYER;
        public static ForgeConfigSpec.ConfigValue<String> MSG_CANCEL_TIMEOUT;
        public static ForgeConfigSpec.ConfigValue<String> MSG_INTERVAL_BROADCAST;
        public static ForgeConfigSpec.ConfigValue<String> MSG_SUCCESS;

        public static ForgeConfigSpec.IntValue AFK_THRESHOLD_MINUTES;
